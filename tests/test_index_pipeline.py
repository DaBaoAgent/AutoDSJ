...
def test_independent_shot_and_script_indexes_start_in_parallel(tmp_path):
    ...
    settings = SimpleNamespace(visual=SimpleNamespace(
        selective_target_frames=90, selective_min_frames=60, selective_max_frames=120,
    ))
